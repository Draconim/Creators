...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Regisztráció') }}
                    <ul class="nav nav-tabs card-header-tabs nav-fill" id="navList" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#hallgato" role="tab">Hallgató</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#dolgozo" role="tab">Dolgozó</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#vendeg" role="tab">Vendég</a>
                        </li>
                    </ul>
                </div>
                <div class="card-body">
                    <div class="tab-content mt3">
                        ...
                        <div class="tab-pane" id="dolgozo" role="tabpanel">
                            <form method="POST" action="{{ route('register') }}">
                                @csrf
                        ...
                        <div class="tab-pane" id="vendeg" role="tabpanel">
                            <form method="POST" action="{{ route('register') }}">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    <label for="address" class="col-md-4 col-form-label text-md-end">{{ __('Lakóhely') }}</label>
